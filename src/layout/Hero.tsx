        ...
        <>
            <div className='grid grid-cols-2 align-items-stretch mt-14' id='inicio'>
                <div className='hero__content flex flex-col items-center w-3/5 m-auto gap-3 animate__animated animate__backInLeft'>
                    ...
                    <a id='text' className='btn bg-customViolet text-white text-lg font-myCustomFontSecondary hover:bg-violet-500 hero__button animate__animated animate__backInLeft' href='https://wa.me/message/X65MZULZJUFYL1' target='_blank'>Contactarse</a>
