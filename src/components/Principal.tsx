import { itemsServices, itemsAbout, itemsServicesIT, itemsServicesMkt } from "../resources"
    ...
    return (
        <>
            <div className='grid grid-cols-2 justify-items-stretch' id='inicio'>
                ...
                <div className='flex flex-col justify-center items-center desktop:m-50 xl:m-48 sm:m-8 animate__animated animate__backInLeft'>
